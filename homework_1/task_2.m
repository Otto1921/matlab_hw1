% Second task (2), write a script that allows someone to enter a temp in 
%Celsius and convert into Farenheit 
%temperature equation for celscuius to Farenheit is F=(C*9/5)+32
%displays result with appropriate formating 
